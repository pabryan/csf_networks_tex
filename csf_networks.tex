...
\end{align*}
Therefore equation \eqref{eq:comparison_ineq} from the Comparison Theorem \ref{thm:comparison} is satisfied provided
\[
...
\[
\begin{split}
0 &\leq 4 (e^{-\tau} \psi_0')^2 \Phi_c'' + \left(4\psi_0'' - \frac{L}{4\pi^2} \bar{Q} x \psi_0' + \frac{L}{2\pi} \Delta Q \psi_0' \right) e^{-\tau} \Phi_c' + e^{-\tau} \psi_0 \Phi_c' + \frac{L}{4\pi^2} \bar{Q} \Phi_c - \Phi_c \\
&= 4 (e^{-\tau} \psi_0')^2 \Phi_c'' + \left(\frac{L}{4\pi^2} \bar{Q} - 1\right) \left(\Phi_c - e^{-\tau} \psi_0 \Phi_c'\right) \\
