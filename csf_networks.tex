...
\[
\partial_t \chordarcprofile \geq 4 \chordarcprofile'' - 2 (1-\tangindicator) \frac{1 - (\chordarcprofile')^2}{\chordarcprofile} + \left(\chordarcprofile - x \chordarcprofile'\right) \frac{1}{L} \bar{Q} + \frac{2\pi}{L} \chordarcprofile' \Delta Q.
\]
\end{theorem}
...
\[
\partial_t \phi \geq 4 \phi'' - 2 (1-\tangindicator) \frac{1 - (\phi')^2}{\phi} + \left(\phi - x \phi'\right) \frac{1}{L} \bar{Q} + \frac{2\pi}{L} \phi' \Delta Q.
\]
\end{proof}
...
\item $\phi$ is weakly concave in $x$ for each $t$,
\item $\limsup_{x\to 0} \frac{\phi}{x} \leq 1$,
\item
\[
\partial_t \phi \leq 4 \phi'' + \left(\phi - x \phi'\right) \frac{1}{L} \bar{Q} + \frac{2\pi}{L} \phi' \Delta Q.
\]
\end{itemize}
If $\phi(x, 0) \leq \chordarcprofile(x, 0)$ for all $x \in [0, 2\pi]$, then $\phi(x, t) \leq \chordarcprofile(x, t)$ for all $x, t$.
\end{theorem}
